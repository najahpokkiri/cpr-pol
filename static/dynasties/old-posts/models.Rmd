...
```{r results = "asis"}
fit.1 <- feglm(dynast ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +linkage +minister_duration +industry + land + post_90 + n_elections_w |district + year  , family = binomial(link = "probit"), data = df)
