...
df <- tibble(dynast, caste_uc,caste_yadav,caste_non_yadav_obc , caste_dalit , caste_muslim ,minister_duration ,industry , school_college , land ,linkage_down,linkage_up, post_90 ,n_elections_w ,district)
```
...
fit.1 <- feglm(dynast ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land +linkage_down+ post_90 +n_elections_w |district, family = binomial(link = "probit" ), data = df)


fit.2 <- feglm(linkage_up ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + post_90+n_elections_w|district, family = binomial(link = "probit"), data = df)



 fit.3 <- feglm(linkage_down ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + dynast+ post_90 +n_elections_w |district , family = binomial(link = "probit"), data = df)
 
 
 
 etable(fit.1, fit.2, fit.3,extraline=list("Caste control"=c("Yes", "Yes", "Yes"))) %>%  slice(-(2:7)) %>% kable(caption = "Regression Results - AE All") %>% kable_styling(full_width = F)
...
df  <- tibble(dynast , caste_uc, caste_yadav,caste_non_yadav_obc , caste_dalit , caste_muslim ,minister_duration ,industry , school_college , land ,linkage_down, post_90 , n_elections_w,district,linkage)
```
...
fit.2 <- feglm(linkage~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + post_90 + n_elections_w| district , family = binomial(link = "probit"), data = df)
...
# 
 ...
 etable(fit.1, fit.2, fit.3,extraline=list("Caste control"=c("Yes", "Yes", "Yes"))) %>%  slice(-(2:7)) %>% kable(caption = "Regression Results - AE GE All") %>% kable_styling(full_width = F)
...
df <- tibble(dynast , caste_uc, caste_yadav,caste_non_yadav_obc , caste_dalit , caste_muslim ,minister_duration ,industry , school_college , land ,linkage_down, n_elections_w,  total_assets  , serious_crime , turncoat, winner, vote_share,district
             )
```
...
fit.1 <- feglm(dynast ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land +linkage_down+ n_elections_w+ log(total_assets)  + serious_crime + turncoat |district, family = binomial(link = "probit"), data= df)


#summary(fit.2)

fit.2 <- feglm(winner ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets) + serious_crime + turncoat + dynast + linkage_down|district , family = binomial(link = "probit"), data = df)

fit.3 <- felm(vote_share ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets) + serious_crime + turncoat + dynast + linkage_down|district, data = df)

etable(fit.1,fit.2,extraline=list("Caste control"=c("Yes",  "Yes"))) %>%  slice(-(2:7)) %>% kable(caption = "Regression Results - AE 2012-17") %>% kable_styling(full_width = F)
...
df <- tibble(dynast , caste_uc, caste_yadav,caste_non_yadav_obc , caste_dalit , caste_muslim ,minister_duration ,industry , school_college , land ,linkage_down, n_elections_w,  total_assets  , serious_crime , turncoat, winner, vote_share,pc
             )
...
```{r results = "asis"}
fit.1 <- feglm(dynast ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land +  linkage_down+n_elections_w+ log(total_assets) + serious_crime + turncoat|pc, family = binomial(link = "probit"), data= df)




fit.2 <- feglm(winner ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets) + serious_crime + turncoat + dynast + linkage_down|pc, family = binomial(link = "probit"), data = df)

fit.3 <- felm(vote_share ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets)  + serious_crime + turncoat + dynast+ linkage_down|pc, data = df)



#summary(fit.3)

etable(fit.1,fit.2,extraline=list("Caste control"=c("Yes",  "Yes"))) %>%  slice(-(2:7)) %>% kable(caption = "Regression Results - GE 2009-19") %>% kable_styling(full_width = F)
...
df <- tibble(dynast , caste_uc, caste_yadav,caste_non_yadav_obc , caste_dalit , caste_muslim ,minister_duration ,industry , school_college , land ,linkage_down, n_elections_w,  total_assets  , serious_crime, non_serious_crime , turncoat, winner, vote_share, constituency, linkage
             )
```
...
fit.1 <- feglm(dynast ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down+n_elections_w+ log(total_assets)  + serious_crime + non_serious_crime+turncoat|constituency, family = binomial(link = "probit"), data = df)




fit.2 <- feglm(winner ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets) + serious_crime + turncoat + dynast + linkage_down|constituency, family = binomial(link = "probit"), data = df)



fit.3 <- feglm(linkage ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets) + serious_crime + turncoat |constituency , family = binomial(link = "probit"), data= df)

fit.4 <- felm(vote_share ~ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + n_elections_w + log(total_assets)  + serious_crime + turncoat + dynast + linkage_down|constituency)

#summary(fit.1)


etable(fit.1,fit.2,fit.3,extraline=list("Caste control"=c("Yes",  "Yes", "Yes"))) %>%  slice(-(2:7)) %>% kable(caption = "Regression Results - AE 2012-17") %>% kable_styling(full_width = F)
