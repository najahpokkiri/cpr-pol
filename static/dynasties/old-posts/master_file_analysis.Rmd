...
ggplot(dyn_non_fam_w)+
  geom_density(aes(x=life_span, y = ..density..),size = 1, color = 'black')+
  geom_vline(xintercept = medx, color = "red")+
  xlim(0,50)+
  ylim(0,.1)+
  geom_vline(xintercept = meanx, color = "blue")+
  geom_text(aes(x=(medx+.75), label="Median", y=0.01), colour="red", size =4, angle = 90 )+
  geom_text(aes(x=(meanx -.75), label="Mean", y = 0.01), colour="blue", size = 4, angle = 90)+
  theme_minimal_hgrid()+
