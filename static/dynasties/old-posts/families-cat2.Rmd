...
fit.life <- felm(fam_life ~  pol_div+ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +ind_edu +  land +entry_years + n_elections_w ,data = fam_df2)
...
| Cut off | 5 years(2012) | 10 years(2009) | 15 years(2005) |
|---------|---------|----------|----------|
| alive   | 128     | 110      | 97       |
| dead    | 130     | 90       | 66       |
| total   | 258     | 200      | 163      |
...
dead.surv4 <- coxph(Surv(fam_life, dead_20) ~  pol_div +minister + ind_edu + land + entry_years +n_elections_w+ caste_uc + caste_yadav + caste_non_yadav_obc+caste_dalit+caste_muslim + factor(decade)  ,data = subset(fam_df3 %>% filter(min_fam_year<2001)))
 ...
 lines <-  list (c("Last ** years","20","15","10","5"),c("Caste control", "Yes","Yes", "Yes", "Yes"), c("Decade control","Yes","Yes", "Yes", "Yes"))
 
stargazer(dead.surv4,dead.surv3, dead.surv1, dead.surv2,type = "html", keep = keep,order = order, covariate.labels = labels,
