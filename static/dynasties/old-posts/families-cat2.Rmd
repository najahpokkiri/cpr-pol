...
```{r, results= "asis"}
stargazer(fit.multinom, type="html", keep = c("success_cat","minister_duration","industry", "school_college", "land", "linkage_down"),add.lines = list (c("Caste control", "Yes","Yes","Yes")))
```
...
fit.3 <- glm(Stable ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down, family= binomial(link = "probit") )
 ...
 stargazer(fit.1,fit.2,fit.3,title="Regression Results - Success of dynasties ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("minister_duration","industry", "school_college", "land", "linkage_down"),add.lines = list (c("Caste control", "Yes","Yes","Yes")))
