...
```{r, results= "asis"}
stargazer(fit.multinom, type="html", keep = c("linkage_down","success_cat","minister_duration","industry", "land", "second_mem_dur"),order = c("linkage_down","success_cat","minister_duration","industry",  "land", "second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c( "Political diversification","Minister duration", "Economic diversification", "Land ownership", "Years took for the second member entry"))
```
