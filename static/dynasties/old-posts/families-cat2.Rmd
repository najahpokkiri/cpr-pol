...
stargazer(fit.multinom, type="html", keep = c("linkage_down","minister_duration","industry", "school_college", "land", "second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c(  "Political diversification","Minister duration", "Economic diversification","Educational ownership", "Land ownership","Years took for the second member entry"))
...
```{r, results= "asis"}
stargazer(fit.multinom, type="html", keep = c("linkage_down","success_cat","minister_duration","industry", "school_college", "land", "second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c( "Political diversification","Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Years took for the second member entry"))
```
...
fit.3 <- glm(Stable ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down+ second_mem_dur, family= binomial(link = "probit") )
 ...
 stargazer(fit.1,fit.2,fit.3,title="Regression Results - Success of dynasties ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("linkage_down","minister_duration","industry", "school_college", "land", "second_mem_dur"),covariate.labels = c("Political diversification", "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Years took for the second member entry"),add.lines = list (c("Caste control", "Yes","Yes","Yes")))
...
fit.3 <- felm(Stable ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down+factor(delim_change))
 ...
 stargazer(fit.1,fit.3,title="Regression Results - Success of dynasties ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("linkage_down","minister_duration","industry", "school_college", "land", "delim_change"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c("Political diversification", "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Delimitation control"))
...
#summary(fit.2)
 ...
 stargazer(fit.1,fit.2,title="Regression Results - Declining v/s Stable ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("linkage_down","minister_duration","industry", "school_college", "land",  "second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes")),covariate.labels = c("Political diversification", "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Years took for the second member entry"))
...
##summary(fit.1)
 ...
 stargazer(fit.1,fit.2,title="Regression Results - Declining v/s   ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("linkage_down","minister_duration","industry", "school_college", "land",  "delim_change"),add.lines = list (c("Caste control", "Yes","Yes")),covariate.labels = c( "Political diversification", "Minister duration", "Economic diversification","Educational ownership", "Land ownership","Delimitation control"))
...
<!--  stargazer(fit.1,fit.2,title="Regression Results - Declining v/s   ",type = "html", -->
<!--             align=TRUE,  no.space=TRUE,keep = c("minister_duration","industry", "school_college", "land", "linkage_down", "delim_change"),add.lines = list (c("Caste control", "Yes","Yes")),covariate.labels = c( "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Political diversification","Delimitation control")) -->
