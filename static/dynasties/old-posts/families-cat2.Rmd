...
fit.span <- felm(life_span ~caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down + second_mem_dur )


#stargazer(fit.span, type = "text")


stargazer(fit.span, type="html", title = "Life span of the family",keep = c( "linkage_down","second_mem_dur","minister_duration","industry", "school_college", "land", "second_mem_dur"),order= c("linkage_down","second_mem_dur","minister_duration","industry", "school_college", "land", "second_mem_dur"),covariate.labels = c( "Political diversification","Minister duration", "Economic diversification","Educational ownership", "Land ownership" , "Years took for the second member entry"), add.lines = list (c("Caste control", "Yes")))
