...
land_caste_df$success_cat<- factor(land_caste_df$success_cat, levels = c("UC","Yadav","OBC","Dalit" , "Muslim"   ))
 ...
 df5$success_cat<- factor(df5$success_cat, levels = c("Upper Caste","OBC","Dalit" , "Muslim"   ))
  ...
  ggsave("D:/cpr/thesis/figures/fig_4_2.png", p4_2,width = 5, height =4, dpi = 300, units ="in" )
```
...
p4_4
  ggsave("D:/cpr/thesis/figures/fig_4_4.png", p4_4,width = 4, height =4, dpi = 300, units ="in" )
...
p3_10 <- ggplot(econ_pol_df2, aes(x=success_cat1, y=minister)) + 
  ...
  ggsave("D:/cpr/thesis/figures/fig_3_10.png", p3_10,width = 5, height =3.5, dpi = 300, units ="in" )
...
ggplot( aes(variable, y = value, fill = success_cat, label = round(value,2)))+
 ...
 p4_5
  ...
  ggsave("D:/cpr/thesis/figures/fig_4_5.png", p4_5,width = 5, height =3.5, dpi = 300, units ="in" )
...
p4_3
  ggsave("D:/cpr/thesis/figures/fig_4_3.png", p4_3,width = 5, height =3, dpi = 300, units ="in" )
...
p3_5
  ...
  ggsave("D:/cpr/thesis/figures/fig_3_5.png", p3_5,width = 5, height =3, dpi = 300, units ="in" )
...
```{r}
rmarkdown::pandoc_convert("D:/cpr/thesis/chaps_word/Chapter4_Aug2.docx", to = "latex",output = "D:/cpr/thesis/chaps_word/Chapter4_Aug2_c1.tex", options = c("-V geometry:margin=.5in"))
...
p3_4
  ggsave("D:/cpr/thesis/figures/fig_3_4.png", p3_4,width = 5, height =3, dpi = 300, units ="in" )
```
...
all_sep <- rbindlist(list(all, sep), use.names = TRUE)
  ...
  p4_1
  ggsave("D:/cpr/thesis/figures/fig_4_1.png", p4_1,width = 5, height =4, dpi = 300, units ="in" )
```
...
#        )
# 
#   ggsave("D:/cpr/thesis/figures/fig_3_7.png", p3_7,width = 5, height =3.5, dpi = 300, units ="in" )
```
...
adr <-fread("D:/cpr/UP/up-dynasties/dyn_other_data/adr_candidatelevel.csv", stringsAsFactors = FALSE)
...
p4_8
 ...
 ggsave("D:/cpr/thesis/figures/fig_4_8.png", p4_8,width = 5, height =4, dpi = 300, units ="in" )
...
p4_9 <- ggplot(all_df4, aes(x=success_cat, y=mean)) +
  ...
  theme(text = element_text(family = "serif"),
        axis.title.x =element_blank())
  ggsave("D:/cpr/thesis/figures/fig_4_9.png", p4_9,width =5 , height =3.5, dpi = 300, units ="in" )
...
p4_6 <- arrange_ggsurvplots(splots2, print = TRUE,
  ...
  ggsave("D:/cpr/thesis/figures/fig_4_6.png", p4_6,width = 6, height =3.5, dpi = 300, units ="in" )
```
...
```{r}
 ...
 p4_7 <-   pol_div_all$plot+ggind_edu_all$plot+
    ...
    ggsave("D:/cpr/thesis/figures/fig_4_7.png", p4_7,width = 6, height =3.5, dpi = 300, units ="in" )
