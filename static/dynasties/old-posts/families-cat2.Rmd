...
fit.life <- felm(fam_life ~  pol_div +ind_edu +  land +entry_years + n_elections_w+ caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim ,data = fam_df)
...
fit.declining <- felm(declining~ pol_div +  ind_edu +  land + entry_years +n_elections_w +caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim , data = subset(fam_df %>% filter(success_cat!= "Rising")))
