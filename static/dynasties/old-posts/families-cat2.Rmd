...
stargazer(fit.mem, type="html", title = "What determines the years needed for the entry of the second member of a family",keep = c("second_mem_dur","minister_duration","industry", "school_college", "land", "linkage_down"),covariate.labels = c( "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Political diversification"), add.lines = list (c("Caste control", "Yes")))
...
```{r, results= "asis"}
stargazer(fit.multinom, type="html", keep = c("success_cat","minister_duration","industry", "school_college", "land", "linkage_down","second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c( "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Political diversification","Years took for the second member entry"))
```
...
fit.3 <- felm(Stable ~  caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim +minister_duration +industry + school_college + land + linkage_down+factor(delim_change))
 ...
 stargazer(fit.1,fit.3,title="Regression Results - Success of dynasties ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("minister_duration","industry", "school_college", "land", "linkage_down","delim_change"),add.lines = list (c("Caste control", "Yes","Yes","Yes")),covariate.labels = c( "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Political diversification","Delimitation control"))
...
#summary(fit.2)
 ...
 stargazer(fit.1,fit.2,title="Regression Results - Declining v/s Stable ",type = "html",
            align=TRUE,  no.space=TRUE,keep = c("minister_duration","industry", "school_college", "land", "linkage_down", "second_mem_dur"),add.lines = list (c("Caste control", "Yes","Yes")),covariate.labels = c( "Minister duration", "Economic diversification","Educational ownership", "Land ownership", "Political diversification","Years took for the second member entry"))
