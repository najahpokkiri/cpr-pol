...
df <- tibble(winner ,   incumbent,  turncoat ,caste_UC_IC, female , terms , dynast , assets  , serious_crime, education,age, state,year,enop, reservation_SCST,recontest, constituency, party, vote_share_pc, inc, bjp, margin_percentage, dynast_winner, position, turnout, asset_winner, incumbent_winner, uc_ic_winner, ser_crime_winner)
# 
...
#   distinct(state_name, year, constituency_no, .keep_all = TRUE) %>% select(state_name, year, constituency_no,n_cand_ac,dyn_contested_ac, dynast_winner, criminal_cand_ac) %>% write.csv("D:/cpr/UP/up-dynasties/dyn_other_data/ge14_pc_stats.csv")
