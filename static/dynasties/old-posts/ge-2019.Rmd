...
# dyn_ge <-dyn_ge %>% select(1:1, 3:5,13:18)
 ...
 dyn_ge <- readxl::read_xlsx("D:/cpr/UP/up-dynasties/dyn_other_data/tcpd_ge_09_14_19_JuneTR.xlsx") %>% select(c(1:1, 3:5, 13:16,18:19)) %>% mutate(dyn = ifelse(as.numeric(dyn)==1,1,0), dyn = ifelse(is.na(dyn),0,dyn))
