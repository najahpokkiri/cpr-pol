...
dyn_ge %>% group_by(state_name, year ) %>% summarise(count = n(),
                                             dyn_1_2 =  sum(ifelse(dyn==1 &position %in% c(1,2),1,0)),
                                             prop_dyn_1_2 = dyn_1_2/count) %>%
  filter(count>16) %>%select(state_name, year,prop_dyn_1_2) %>% filter(state_name %!in% c("jammu & kashmir","jharkhand") )%>% ungroup() %>% 
...
fit.1 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2|0|0|state, data = subset(df %>% filter(position==1)))



fit.2 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2|year|0|state, data = subset(df %>% filter(position==1)))

fit.3 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2|state|0|state, data = subset(df %>% filter(position==1)))

fit.4<- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2| state+year|0|state, data = subset(df %>% filter(position==1)))




fit.5<- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2|constituency_id+ state+year|0|state, data = subset(df %>% filter(position==1)))
...
fit.1 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2+lagged_turnout|0|0|state, data = subset(df %>% filter(position==1)))



fit.2 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2+lagged_turnout|year|0|state, data = subset(df %>% filter(position==1)))

fit.3 <- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2+lagged_turnout|state|0|state, data = subset(df %>% filter(position==1)))

fit.4<- felm(turnout~  dynast_1_2+ reservation_SCST + margin_percentage+enop+criminal_1_2+lagged_turnout| state+year|0|state, data = subset(df %>% filter(position==1)))
