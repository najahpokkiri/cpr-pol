...
```{r, results= "asis"}
etable(fit.poisson, fit.probit, fit.probit_no_se,drop = c("caste_uc", "caste_yadav", "caste_non_yadav_obc" , "caste_dalit" , "caste_muslim") , subtitles = c("Poisson", "Probit", "Probit without SE Clustered")) %>% kable() %>% kable_styling(full_width = F)
