...
```{r}
ge_5pc %>%  group_by(year,dynast) %>%  summarise(mean_vote_share = mean(vote_share_percentage))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 0) %>% kable_styling(full_width = F)
...
```{r}
ge_5pc %>%  group_by(year,dynast) %>%  summarise(mean_turncoat = mean(turncoat))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
...
```{r}
ge_5pc %>%  group_by(year,dynast) %>%  summarise(mean_turncoat =mean(same_party, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
```
...
ge_5pc %>%  group_by(year,dynast) %>%  summarise(mean_recontest = mean(recontest, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
...
```{r}
ae_5pc %>%  group_by(year,dynast) %>%  summarise(mean_turncoat = mean(turncoat))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
...
```{r}
ae_5pc %>%  group_by(year,dynast) %>%  summarise(mean_turncoat =mean(same_party, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
```
...
ae_5pc %>%  group_by(year,dynast) %>%  summarise(mean_incumbent = mean(incumbent, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
...
ae_5pc %>%  group_by(year,dynast) %>%  summarise(mean_recontest = mean(recontest, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
...
```{r}
ae_5pc %>%  group_by(year,dynast) %>%  summarise(mean_no_terms = mean(no_terms, na.rm = TRUE))  %>%reshape2::dcast(dynast  ~ year) %>% replace(is.na(.),0)%>% kable(digits = 2) %>% kable_styling(full_width = F)
```
...
```{r}
ae_5pc%>%  group_by(year,dynast, constituency_type) %>% summarise(count  = n()) %>% group_by(dynast,year) %>% mutate(sum = sum(count), prop = count/sum) %>% reshape2::dcast(year +dynast  ~ constituency_type) %>% kable(digits = 2) %>% kable_styling(full_width = F)
