...
dyn$level_log_cum <- ifelse(dyn$level_log_cum==TRUE, "Politically diversified - Yes", "Politically diversified - No")


dyn$level_log_cum <- factor(dyn$level_log_cum, levels = c("Politically diversified - Yes", "Politically diversified - No"))
...
# unique(dyn_adr_fam$level_log_cum)
...
dyn_indus_ae_ge_uniq <- dyn_indus_ae_ge_uniq %>% mutate(level_log= ifelse(level %in% c("AE", "GE"), "Politically diversified - No", "Politically diversified - Yes"))

dyn_indus_ae_ge_uniq$level_log <- factor(dyn_indus_ae_ge_uniq$level_log, levels = c("Politically diversified - Yes", "Politically diversified - No"))
