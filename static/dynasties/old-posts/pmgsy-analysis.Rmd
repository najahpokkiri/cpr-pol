...
dyn <- fread("~/cpr/UP/up-dynasties/dyn_other_data/dyn_ae_ge.csv", header = TRUE)
...
pmgsy_ac <- fread("~/cpr/data/up_misc/merged_ac_all.csv")
...
nl <- fread("~/cpr/data/controls/nl_94_13.csv", header = TRUE)
...
```{r}
raw_data <- readxl::read_xlsx("~/cpr/data/up_misc/PMGSY Contractors.xlsx", sheet = 1:1)
```
...
```{r}
pwd<- fread("~/cpr/UP/up-dynasties/dyn_other_data/roads-uppwd.csv", stringsAsFactors = FALSE)
...
pmgsy <- readxl::read_xlsx("~/cpr/data/up_misc/PMGSY Contractors.xlsx")
