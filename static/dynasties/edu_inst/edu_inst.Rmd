...
# str_sub(head(shrug_adr$ac_id), -3)
# 
# str(shrug_adr)

dyn_up_college_adr <- inner_join(dyn_up_college, shrug_adr_up, by =c("year_el" = "year", "AC_NO"= "ac_no"))
...
fit.poisson <- glm(data = dyn_up_college_adr, n_colleges ~ dyn_cum_2+caste_uc+ caste_yadav+caste_non_yadav_obc + caste_dalit + caste_muslim  + ed+ assets + num_crim+ 
...
align=TRUE,  no.space=TRUE, keep = c("dyn_cum_2" ,    "ed", "num_crim", "assets",      "caste_uc", "caste_yadav"   ,      "caste_non_yadav_obc" ,"caste_dalit"   ,"caste_muslim" ),omit.stat=c("LL","ser","f"),add.lines=list(c('Year fixed effects', 'Yes','Yes','Yes','Yes' )))
...
fit.poisson <- glm(data = dyn_in_college_adr, n_colleges ~ dyn+ ed+ assets + num_crim+ 
...
align=TRUE,  no.space=TRUE, keep = c("dyn" ,"ed","assets","num_crim"),omit.stat=c("LL","ser","f"),
add.lines=list(c('Year fixed effects', 'Yes','Yes','Yes','Yes' ), c('State fixed effects', 'Yes','Yes','Yes','Yes')))
```
