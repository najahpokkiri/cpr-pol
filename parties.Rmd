...
ge_all <- fread("D:/cpr/data/tcpd/TCPD_GE_all.csv")
  ...
  # names(e_all) <- make.unique(names(ae_all))
...
win_cont_df <- rbind(win_df, cont_df)
 ...
 p3_2 <-  ggplot(win_cont_df,aes(factor(year), prop, fill = party))+
  geom_bar(stat= "identity",position ="dodge" )+
  scale_fill_grey()+
...
ggsave("D:/cpr/thesis/figures/fig_3_2.png", p3_2,width = 5, height =3.5, dpi = 300, units ="in")
```
